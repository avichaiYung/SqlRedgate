...
-- =============================================
CREATE PROCEDURE [dbo].[TLRM_USG_InsertUDR_TMP] 	
	@udrStatusID int, 
...
BEGIN
	...
	INSERT INTO TLRM_USG_UDRs_TMP
							 ...
							 cellularDeviceIMEI, countryID, udrVersion, udrAttA, udrAttB, udrAttC, atUsageKey, threadID, udrCreatedate)
	VALUES        (@udrStatusID, @udrStatusDate, @udrFileID, @orderProductID, @udrSubscriberID, @udrIP, @udrSVID, @udrNetworkElement, @udrServiceStartTime, @udrServiceEndTime, @applicationTypeID, @udrRxBytes, @udrTxBytes, @productID, 
							 @cellularDeviceIMEI, @countryID, @udrVersion, @udrAttA, @udrAttB, @udrAttC, @atUsageKey, (ABS(CHECKSUM(NewId())) % 40) + 1, @udrCreatedate)
