...
-- =============================================
CREATE PROCEDURE [dbo].[TLRM_DW_OP_GetCOuntryUsagePerDay]
	@orderProductID int,
	@InternalOrderID int,
	@FromDate datetime,
	@ToDate datetime,
...
DECLARE	
	...
	SET @sqlStr = '	SELECT TLRM_USG_Usage.usageDate, TLRM_USG_Usage.CountryID, ISNULL(SUM(CASE WHEN usageWebbingSIM = 1 THEN 0 ELSE usageQuota END), 0) AS TotalWebbingUsage, 
	...
	SET @sqlStr = @sqlStr + ' GROUP BY TLRM_USG_Usage.usageDate, TLRM_USG_Usage.CountryID '
